<template>
  <AdminLayout>
    <div class="min-h-screen bg-animated-gradient p-6">
      ...
      <div class="mb-6">
        <h1 class="text-4xl font-bold text-white mb-2">Edit Menu Category</h1>
        <p class="text-white/80">Update category details</p>
      </div>
...
const submit = () => {
  form.post(route('admin.menu-categories.update', props.category.category_id), {
    forceFormData: true,
  })
}
